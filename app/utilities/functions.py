...
def create_and_map_language(country: object, languages: list) -> None:
    ...
    Steps of operations:
        ...
        3. Maps the country with the newly created or existing language by creating a new entry in CountryLanguage Table.
...
def create_and_map_neighbouring_country(data: list, country: object, neighbours: list) -> list:
    ...
    After execution, returns the data(list of dicts or list of JSON objects of countries)
    Steps of operations:
        ...
        4. Creates and maps Languages which are spoken by the newly created or existing Country.
        5. Maps this country(neighbour country) with the given country by creating new entry in CountryNeighbour Table.
        6. Invokes iteself recursively until the neighbours list becomes empty. During recursion, it sends the
            updated data list in the argument.
        7. Finally returns the data list.'''
    if len(neighbours) == 0:
        return data
    else:
...
def get_data() -> None:
    '''Steps of operations:
        ...
        3. Creates Languages that are spoken by the country.
